    ...
    <div class="container ">
        ...
        <form class="row" action= "../controler/actualizar/actualizarusuarios.php" method="POST">
             ...
             <div class="col-6">
                ...
                <input type="number" class="form-control" id="identificacion" name="identificacion" placeholder="Ingrese Cedula" value="<?=$identificacion['identificacion']?>">
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
            <button   onclick="guardar()" type="submit" class="btn btn-success">Actualizar</button>
            </div>
